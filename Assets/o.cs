...
#pragma warning restore CS0108 // Member hides inherited member; missing new keyword
    ...
    public GameObject FirstPersonGunThing;
    ...
    void Controls2()
    {
        ...
        {
            FirstPersonGunThing.SetActive(true);
            gameObject.GetComponent<Shoot_Bullet>().enabled = false;
        ...
        {
            FirstPersonGunThing.SetActive(false);
            gameObject.GetComponent<Shoot_Bullet>().enabled = true;
        }
    }
    public bool CheckForCeiling()
    {
        RaycastHit2D Ceiling;
        Ceiling = Physics2D.BoxCast(gameObject.transform.position, new Vector2(1f, 5), 0f, Vector2.up, 1f, Walls);
