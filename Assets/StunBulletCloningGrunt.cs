...
public class StunBulletCloningGrunt : MonoBehaviour
{
    public float time;
    ...
    void Update()
    {
        ...
        //if (!o.GetComponent<o>().Stunned && Time.time - time >= 1f && gameObject.GetComponent<GruntScript>().isInGruntRange && o.GetComponent<o>().CanBeShot)
        //{
        //   time = Time.time;
        // Debug.Log(gameObject.GetComponent<GruntScript>().follow);
